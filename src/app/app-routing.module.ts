...
const routes: Routes = [
  ...
  {
    path: 'players',
    loadComponent: () => import('./pages/players/players.module').then(m => m.PlayersModule),
    title: 'Finder | All Players',
    data: {preload: true}
  },
  {
    path: 'leaderboards',
    loadComponent: () => import('./pages/leaderboards/leaderboards.module').then(m => m.LeaderboardsModule),
